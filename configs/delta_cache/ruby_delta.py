...
MESI_Three_Level.create_system(args, 
                               full_system=False, 
                               system=system, 
                               cpu_ports=cpu_ports)
...
l3_cntrls = getattr(system.ruby, 'l3_cntrl', getattr(system.ruby, 'l3_cntrls', []))
...
system.mem_ctrls = [MemCtrl(dram=DDR3_1600_8x8(range=system.mem_ranges[0]),
                            port=p) for p in system.ruby.memory_out_port]
